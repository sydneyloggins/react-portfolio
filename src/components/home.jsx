  ...
  return (
    <div name='home' className='w-full h-screen bg-[#0a192f]'>
        ...
        <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
            ...
            <h1 className='text-4xl sm:text-6xl font-bold text-[#ccd6f6]'>Sydney Loggins</h1>
            <h2 className='text-4xl sm:text-4xl py-4 font-bold text-[#8892b0]'>Full Stack Developer</h2>
        ...
        <div>
            <button className='text-white group border-2 px-6 py-3 my-2 flex items-center hover:bg-blue-400 hover:border-blue-400 '> <Link  to="projects"  smooth={true}  duration={500}>View Work</Link>
